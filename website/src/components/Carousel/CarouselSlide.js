    ...
    return (
        <div className="relative w-full">
            ...
            <section className="absolute top-2 left-5 w-full px-2 md:top-44 lg:top-56 xl:top-80">
                ...
                <p className="max-w-[90%] text-gray-200 sm:text-sm md:ml-10 md:block md:max-w-[70%] lg:ml-14 lg:text-base">
                    {description}
                </p>
            </section>
            ...
            <img
                src={imageSrc}
                className="h-[340px] w-full object-cover md:h-[600px] xl:h-[750px]"
